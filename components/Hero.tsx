...
export default function Hero() {
    return (
        <section className="min-h-[calc(100vh-4rem)] flex flex-col justify-center items-start px-6 md:px-20 bg-transparent overflow-hidden relative">
            ...
            >
                <Badge variant="outline" className="mb-6 text-sm font-medium px-4 py-1.5 rounded-full border-primary/50 text-white bg-primary/10 backdrop-blur-md">
            ...
            <motion.h1
                ...
                className="text-5xl md:text-8xl font-black tracking-tighter leading-tight mb-8 z-10"
            >
                ADITYA SHARMA
            </motion.h1>
            ...
            <motion.p
                ...
                className="text-xl md:text-3xl font-light text-zinc-300 mb-4 leading-relaxed"
            >
